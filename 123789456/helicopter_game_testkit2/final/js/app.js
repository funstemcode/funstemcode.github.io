...
function init() {
    terrainPattern = ctx.createPattern(resources.get('img/terrain.png'), 'repeat'); //CREATE BACKGROUND
...
var player = {
   ...
   // sprite: new Sprite('img/sprites.png', [0, 0], [39, 39], 4, [0,1]) // This is the original
    sprite: new Sprite('img/sprites.png', [80, 0], [35, 35], 4, [0,1,2,3,4,5,6])
    ...
    if(Math.random() < 1 - Math.pow(.995, gameTime)) {
        ...
        enemies.push({
           ...
           // pos: [canvas.width, canvas.height - 39],   
            ...
            sprite: new Sprite('img/sprites.png', [0, 78], [80, 39], 6, [0])
        });
    }
